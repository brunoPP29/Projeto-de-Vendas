...
if (isset($_POST['acaoDeletar']) && isset($_POST['idDeletar'])) {
  echo '<div class="alert alert-warning mx-auto mt-3" style="max-width: 800px;" role="alert">
    <p><i class="bi bi-exclamation-triangle me-2"></i>Tem certeza que deseja deletar este plano?</p>
  ...
  <div class="card shadow rounded">
    ...
    <div class="card-body">
      ...
      if (isset($_POST['acao'])) {
        ...
        echo '<i class="bi bi-info-circle me-2"></i>Mostrando resultados para: <strong>' . htmlspecialchars($busca) . '</strong>';
        echo '</div>';
        echo '</div>';
      ...
      ?>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center border p-3 mb-3 rounded">
          ...
          <!-- Botões -->
          <form method="post" class="mt-3 mt-md-0 d-flex">
